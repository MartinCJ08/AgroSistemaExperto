...
germina(melon,4,7).
germina(mostaza,4,10).
%%recoleccion desde la siembra(hortaliza,)
recoleccion(acelga,90,95).
...
recoleccion(berro,60,65).
recoleccion(brocoli,60,100).
recoleccion(calabacin,100,105).
recoleccion(calabaza,120,120).
recoleccion(canonigo,40,60).
recoleccion(cardos,120,150).
recoleccion(cebollaTemprana,100,105).
recoleccion(cebollaTardia,100,100).
recoleccion(cebollin,110,120).
recoleccion(ciboulette,90,95).
recoleccion(cilantro,90,95).
recoleccion(coliflor,90,95).
recoleccion(eneldo,90,95).
recoleccion(escarola,90,95).
recoleccion(espinaca,60,90).
recoleccion(estragon,90,95).
recoleccion(fresas,100,120).
recoleccion(garbanzos,110,115).
recoleccion(haba,90,95).
recoleccion(hinojo,70,100).
recoleccion(lavanda,90,95).
recoleccion(lechuga,90,100).
recoleccion(maiz,100,120).
recoleccion(manzanilla,100,120).
recoleccion(mejorana,100,120).
recoleccion(menta,90,95).
recoleccion(melisa,90,110).
recoleccion(melon,100,120).
recoleccion(mostaza,100,120).
%%mes para plantar en el hemiserio sur.
mes(acelga,['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre']).
mes(chile,['Agosto','Septiembre']).
mes(ajo,['Abril','Mayo','Junio','Julio','Agosto']).
%% mes(albahaca,[]).
mes(alchachofa,['Agosto','Noviembre']).
mes(anquito,['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre']).
mes(apio,['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre']).
mes(arveja,['Junio','Julio','Agosto']).
mes(batatas,['Septiembre','Octubre']).
mes(berenjena,['Agosto','Septiembre','Octubre','Noviembre']).
mes(berro,['Agosto','Septiembre','Octubre','Noviembre','Diciembre']).
mes(brocoli,['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre']).
mes(calabacin,['Septiembre','Octubre','Noviembre','Diciembre','Enero']).
mes(calabaza,['Noviembre','Octubre']).
mes(canonigo,['Enero','Febrero','Marzo']).
mes(cardos,['Septiembre','Octubre','Noviembre']).
mes(cebollaTemprana,['Octubre','Noviembre','Diciembre''Enero','Febrero']).
mes(cebollaTardia,['Abril']).
mes(cebollin,['Febrero','Abril']).
mes(ciboulette,['Septiembre','Octubre','Noviembre','Diciembre']).
mes(cilantro,['Diciembre','Enero','Febrero','Marzo','Abril','Mayo']).
mes(coliflor,['Octubre','Noviembre','Diciembre','Enero','Febrero']).
mes(eneldo,['Octubre','Noviembre']).
mes(escarola,['Agosto','Septiembre','Octubre','Noviembre','Diciembre','Enero','Febrero']).
mes(esparrago,['Julio','Agosto']).
mes(espinaca,['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre']).
mes(estragon,['Septiembre','Octubre','Noviembre','Diciembre']).
mes(fresas,['Septiembre','Octubre','Noviembre','Diciembre']).
mes(garbanzos,['Abril','Mayo']).
mes(haba,['Septiembre','Octubre']).
mes(hinojo,['Abril','Mayo','Junio']).
mes(lavanda,['Septiembre','Octubre','Noviembre','Diciembre']).
mes(lechuga,['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre']).
mes(maiz,['Octubre','Noviembre','Diciembre','Enero']).
mes(manzanilla,['Septiembre','Octubre','Noviembre']).
mes(mejorana,['Septiembre','Octubre','Noviembre']).
mes(menta,['Septiembre','Octubre','Noviembre','Diciembre']).
mes(melisa,['Septiembre','Octubre','Noviembre','Diciembre','Enero','Febrero']).
mes(melon,['Septiembre','Octubre','Noviembre','Diciembre','Enero','Febrero']).
mes(mostaza,['Septiembre','Octubre','Noviembre','Diciembre','Enero','Febrero']).