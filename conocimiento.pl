...
mes(acelga,['Enero','Febrero','Marzo','Abril','Mayo','Junio',7,8,'Septiembre',10,11,12]).
mes(chile,[8,9]).
mes(ajo,['Abril','Mayo','Junio',7,8]).
%% mes(albahaca,[]).
mes(alchachofa,[8,9]).
mes(anquito,['Enero','Febrero','Marzo','Abril','Mayo','Junio',7,8,'Septiembre',10,11,12]).
mes(apio,['Enero','Febrero','Marzo','Abril','Mayo','Junio',7,8,'Septiembre',10,11,12]).
mes(arveja,[6,7,8]).
mes(batatas,[9,10]).
mes(berenjena,[8,'Septiembre',10,11]).
mes(berro,[8,'Septiembre',10,11,12]).
mes(brocoli,['Enero','Febrero','Marzo','Abril','Mayo','Junio',7,8,'Septiembre',10,11,12]).
mes(calabacin,[9,10,11,12,'Enero']).
mes(calabaza,[10,11]).
mes(canonigo,['Enero','Febrero',3]).
mes(cardos,[9,10,11]).
mes(cebollaTemprana,[10,11,12,'Enero',2]).
mes(cebollaTardia,[4]).
mes(cebollin,[2,3]).
mes(ciboulette,[9,10,11,12]).
mes(cilantro,[12,'Enero','Febrero','Marzo','Abril',5]).
mes(coliflor,[10,11,12,'Enero',2]).
mes(eneldo,[10,11]).
mes(escarola,[8,'Septiembre',10,11,12,'Enero',2]).
mes(esparrago,[7,8]).
mes(espinaca,['Enero','Febrero','Marzo','Abril','Mayo','Junio',7,8,'Septiembre',10,11,12]).
mes(estragon,[9,10,11,12]).
mes(fresas,[9,10,11,12]).
mes(garbanzos,['Abril',5]).
mes(haba,[9,10]).
mes(hinojo,['Abril','Mayo',6]).
mes(lavanda,[9,10,11,12]).
mes(lechuga,['Enero','Febrero','Marzo','Abril','Mayo','Junio',7,8,'Septiembre',10,11,12]).
mes(maiz,[10,11,12,'Enero']).
mes(manzanilla,[9,10,11]).
mes(mejorana,[9,10,11]).
mes(menta,[9,10,11,12]).
mes(melisa,[9,10,11,12,'Enero',2]).
mes(melon,[9,10,11,12,'Enero',2]).
mes(mostaza,[9,10,11,12,'Enero',2]).