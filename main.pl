...
send(TxtProfundidad, editable, @off),
send(TxtGerminaUno, editable, @off),
send(TxtGerminaDos, editable, @off),
send(TxtRecoleccionUno, editable, @off),
send(TxtRecoleccionDos, editable, @off),
send(TxtDisPlant, editable, @off),
send(TxtDisHil, editable, @off),
send(TxtInfo, editable, @off),
send_list(Dinfo,append,[MenuHor,TxtProfundidad,TxtGerminaUno,TxtGerminaDos,TxtRecoleccionUno,
	TxtRecoleccionDos,TxtDisPlant,TxtDisHil,TxtInfo,BtnVer,LblSiembra]),
